...
return (
  <Disclosure as="nav" className="fixed w-full bg-red-800">
   <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <DisclosureButton data-collapse-toggle="navbar-solid-bg" type="button" class="inline-flex w-full items-start p-2  h-10 justify-start text-sm text-gray-500 rounded-lg md:hidden hover:bg-red-950 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-solid-bg" aria-expanded="false">
